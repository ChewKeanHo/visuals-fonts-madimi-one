# Madimi One Font | (Holloway) Chew, Kean Ho's Creative Visuals

[![banner](/Pictures/banner_1200x630.svg)](#)

Madimi One is a Latin (ID: `*Latn`) Sans Serif font designed by
[The Madimi One Project Team](https://github.com/TaVaTake/madimi). Its design
was based on gentle curved geometry of certain Southern Afrikan graphic symbols
like KiNtu symbologies; exhibiting subtle visual subtext of Afrikan visual
traditions. Its style is simple, clean and round edged; visibily clear and easy
to read.

This font is ideal for all general use like poster title, poster text, poster
...
```
Title: Madimi One Font
Creators: The Madimi One Project Team
Packaged-By: (Holloway) Chew, Kean Ho
Contact: hello@chewkeanho.com
SKU: chewkeanho-visuals-fonts-madimi-one
UUID: BC2B5FB7-653F-4495-AE01-FCE02C2CC8C0
License: SIL Open Font License (http://scripts.sil.org/OFL)
Repository Made On: 2026-04-09
Repository Made From: Malaysia, South East Asia
Procure: https://github.com/ChewKeanHo/visuals-fonts-madimi-one
```
